...
# benchmark API for Intel Inspector
...
def benchmark():
    ...
    with open(os.path.join(app.config['UPLOAD_FOLDER'], "intelbenchmark.txt"),
              "w") as tsanfile:
...
def upload():
    ...
    if request.method == "POST":
        ...
        logFile = "/home/rds/dataracebench/results/log/" + name + ".inspector.parser.log"
